...
//Putting each function generated above into object called randomFunc
const randomFunc = {
...
// Adding an eventlistener to clipboardEl to listen for a click
...
clipboardEl.addEventListener('click', () => {
  ...
  alert("Copied password to the clipboard! " + copyText.value);
